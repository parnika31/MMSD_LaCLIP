import os
from model import MV_CLIP, LACLIP
...
def set_args():
    ...
    parser.add_argument('--model', default='MV_CLIP', type=str, help='the model name', choices=['MV_CLIP','LACLIP'])
    ...
    parser.add_argument('--tag', default='mm', type=str, help='experiment notes/ description')
