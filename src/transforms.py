...
from laclip_model_arch import CLIP, convert_weights_to_fp16, resize_pos_embed
# from laclip import CLIP, convert_weights_to_fp16, resize_pos_embed
from open_clip.openai import load_openai_model
from open_clip.pretrained import get_pretrained_url, download_pretrained
